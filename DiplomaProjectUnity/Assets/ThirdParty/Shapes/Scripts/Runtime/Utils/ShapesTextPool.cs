...
namespace Shapes {
	...
	[ExecuteAlways] public class ShapesTextPool : ShapesObjPool<TextMeshPro, ShapesTextPool> {

		public override string PoolTypeName => "Text";

		public override void OnCreatedNewComponent( TextMeshPro comp ) {
			comp.enableWordWrapping = false;
